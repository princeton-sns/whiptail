...
class Client {
   public:
    ...
    void SetLatFromSessionState(Latency_t* latency_t, Latency_Frame_t* latency_frame, uint64_t sid) {
        latency_t_ = latency_t;
        latency_map_[sid] = latency_frame;
    }
   ...
   protected:
    ...
    Stats stats;
    std::unordered_map<uint64_t, Latency_Frame_t*> latency_map_;
